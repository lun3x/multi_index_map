...
fn test_insert_and_remove_by_field1() {
    ...
    let elem2 = TestElement {
        ...
        field2: "ElementTwoFieldTwo".to_string(),
    };
    map.insert(elem1);
    map.insert(elem2);
